...
// x * a + b lazy segment tree arithmatic operation - multiply and add
...
struct SegmentTreeLazy {
    ...
    inline void apply(int ind, int st, int end, PA val) {
        ...
        ToPush[ind] = true;
        M[ind].totalSum *= val.first;
        M[ind].totalSum += (end - st + 1) * val.second;
    }
